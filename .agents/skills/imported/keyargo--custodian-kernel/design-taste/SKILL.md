...
- **Lorem ipsum.** Replace with realistic placeholder content that sounds like the product.
- **Marketing buzzword overload.** Cut "synergy", "leverage", "transformative", "best-in-class". Use plain language.
- **Inconsistent date/time formats.** Pick one format and use it throughout. ISO 8601 (`2026-06-23`) is the safest default.
