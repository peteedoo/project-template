...
Set the required environment variables before use. Until configured, `custodian tools run github-comment` returns a stub response indicating which variables are needed.

## Usage

```bash
custodian tools run github-comment --param value
```
